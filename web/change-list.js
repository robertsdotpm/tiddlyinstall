// One rendering of a list of catalogue changes (web/overlay.js), used by the
// Runtimes page (web/catalog-editor.js: the changes in use, and an imported
// file's review) and by the once-a-session prompt for changes found in this
// browser's storage (web/overlay-consent.js).
//
...
//
// `files` is the catalogue's files as far as they are unpacked (web/overlay.js
...
/* ---------- DOM helpers (shared with web/catalog-editor.js) ---------- */
