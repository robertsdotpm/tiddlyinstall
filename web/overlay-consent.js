...
// web/overlay.js, which keeps them out of every build and preview until this
// is answered).
//
...
// do with the Runtimes page's own change list (web/change-list.js).
...
// Called by every page that can build with the catalogue (web/new.js,
// web/build.js, web/catalog-editor.js); the first call does the work.
