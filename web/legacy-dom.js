...
// JavaScript crypto (web/lib/cryptox.js) does the hashing and signing. Without
// either, crypto.getRandomValues stays missing and everything that needs
// random numbers stays off (web/sign-ui.js offers no signing then); nothing
// here makes them up.
(function () {
  ...
  // setAttribute (web/catalog-editor.js el()).
