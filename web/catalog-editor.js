...
// by web/overlay.js as an overlay in this browser and used by web/local-api.js
...
// screens (web/css/style.css); measured when the list is first drawn and again
...
/* ---------- DOM helpers (web/change-list.js: el, short, show) ---------- */
...
// The page's catalogue is unpacked a folder at a time (web/overlay.js): a
...
// web/change-list.js, against the catalogue as far as it is unpacked.
...
function paintChanges() {
  ...
  // at the top of the page, or set aside for this session (web/overlay.js).
