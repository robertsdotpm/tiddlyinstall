...
// web/sign-services.js; this is only the panel around it. Credentials follow
...
// one module plus one descriptor file (web/api.js builds its settings panel
...
export function paintSign(kind, programName) {
  ...
  // it doesn't (plain http:// pages, old browsers; web/lib/cryptox.js). Only the
