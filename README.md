...
| `new.html` | The installer form. Simple view asks only what to package, the language and platforms; everything else is optional, collapsed under "Customise" with its default shown |
