...
| `new.html` | The installer form. Main view: app name, where the code comes from (a GitHub repo or package, or written on the page: template, editor, packages, Run), language, platforms, offline installers. Everything else, including the signing choice, is optional and collapsed under "Customise" with its default shown |
