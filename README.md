...
| `new.html` | The installer form. Main view: app details (name, version, description, publisher, icon — reused for the installed launcher), what to package, language, platforms. Everything else is optional, collapsed under "Customise" with its default shown |
