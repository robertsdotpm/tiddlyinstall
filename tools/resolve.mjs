...
// loaded as the build server loads it (backend/lib/catalog.js).
//
...
import { resolve, resolveFiles, validPackage, packagePolicyFor, packageProject, packageModule } from '../js/resolve.js';
...
const o = {
  ...
  cache: path.join(REPO, 'backend/data/sha-cache.json'), runtime: 'python', select: 'newest', range: '',
