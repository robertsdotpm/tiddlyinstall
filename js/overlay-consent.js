...
// js/overlay.js, which keeps them out of every build and preview until this
// is answered).
//
...
// do with the Runtimes page's own change list (js/change-list.js).
...
// Called by every page that can build with the catalogue (js/new.js,
// js/build.js, js/catalog-editor.js); the first call does the work.
