...
// through web/lib/zlib.js and web/lib/cryptox.js (native, else plain JavaScript).
//
...
// A runtime's `unsupported` rules (server/policy.json): a combination the
...
// system, shared/templates.js), after the runtime's, without repeats.
