...
//
//   - web/new.js, in the page: reads the form's elements and posts JSON;
//   - server/server.js, for a plain form post (POST /submit, from browsers
...
// The code templates of "I'll write it here" are shared/templates.js's. This is
// runtime -> template -> the form's <textarea> name -> the file it becomes;
// new.html's editors are rendered from the same data (web/new.js).
...
// (server/lib/pages.js) has the offline tick and nothing else.
