...
// page's code must then take its plain-JavaScript paths (src/web_client/lib/zlib.js,
// src/web_client/lib/cryptox.js), and anything still calling the native API fails loudly.
//
