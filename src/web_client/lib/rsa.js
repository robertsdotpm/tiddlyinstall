// RSA PKCS#1 v1.5 signatures (RFC 8017) over src/web_client/lib/bignum.js, for browsers
// without WebCrypto. src/web_client/lib/cryptox.js uses this only when the native RSA is
...
// (src/web_client/browser-check.js says so, and key generation needs it too), but
