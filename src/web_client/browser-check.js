...
// The stand-ins are src/web_client/lib/zlib.js and src/web_client/lib/cryptox.js (with the plain-JavaScript
// modules under them), src/web_client/has-shim.js and src/web_client/polyfills.js (docs/plan.md
...
// src/web_client/page-loader.js, which runs it when this sets window.TI_ES5_OK.
(function () {
  ...
  // What the page's ES5 copy needs (keep in step with src/web_client/legacy-dom.js and
  ...
  // src/web_client/legacy-dom.js (since the catalogue unpacks a folder at a time; before,
  ...
  // Classes on <html> for the stylesheet (src/web_client/css/style.css, "Phones and small
  ...
  // This CSS is carried here, not in src/web_client/css/style.css, on purpose: part
  ...
  //
  // Width, padding and edges are .api-banner's (src/web_client/css/style.css section
