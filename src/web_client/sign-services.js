...
//
// src/web_client/lib/authenticode.js does everything else. `beginPE` gives the digest,
...
// panel builds (src/web_client/sign-ui.js) and the tests replace with one that points at
