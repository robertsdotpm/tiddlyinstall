...
// by src/web_client/overlay.js as an overlay in this browser and used by src/web_client/local-api.js
...
// screens (src/web_client/css/style.css); measured when the list is first drawn and again
...
/* ---------- DOM helpers (src/web_client/change-list.js: el, short, show) ---------- */
...
// The page's catalogue is unpacked a folder at a time (src/web_client/overlay.js): a
...
// src/web_client/change-list.js, against the catalogue as far as it is unpacked.
...
function paintChanges() {
  ...
  // at the top of the page, or set aside for this session (src/web_client/overlay.js).
