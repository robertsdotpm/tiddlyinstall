// One rendering of a list of catalogue changes (src/web_client/overlay.js), used by the
// Runtimes page (src/web_client/catalog-editor.js: the changes in use, and an imported
// file's review) and by the once-a-session prompt for changes found in this
// browser's storage (src/web_client/overlay-consent.js).
//
...
//
// `files` is the catalogue's files as far as they are unpacked (src/web_client/overlay.js
...
/* ---------- DOM helpers (shared with src/web_client/catalog-editor.js) ---------- */
