...
// JavaScript crypto (src/web_client/lib/cryptox.js) does the hashing and signing. Without
// either, crypto.getRandomValues stays missing and everything that needs
// random numbers stays off (src/web_client/sign-ui.js offers no signing then); nothing
// here makes them up.
(function () {
  ...
  // setAttribute (src/web_client/catalog-editor.js el()).
