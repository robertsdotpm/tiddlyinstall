// The runtime catalogue for the server: src/shared/resolve.js loaded from the
...
// (src/build_server/internal/catalog/local.go, retired): it finds them by name and size, and
...
import { loadCatalogFiles } from '../../shared/resolve.js';
