...
// src/shared/builder.js needs from a server (stored records, sources and icons,
...
const SIGNED_BY = 'TiddlyInstall TEST';   // our test certificate (src/installers/windows)
...
export class Builder {
  ...
  // src/shared/github.js reads: {status, headers, text}. The derivation on
  ...
  // The env src/shared/builder.js runs a job with on the server.
  env() {
    return {
      catalog: this.cat,
