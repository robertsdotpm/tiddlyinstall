...
import { resolveFiles, writeSnapshot, loadSnapshot } from '../../shared/resolve.js';
...
test('release parts: extra files with their own mirrors; windowed program for console 0', async (t) => {
  ...
  assert.equal(block, [
    ...
    // says so (design.md 1.3, src/shared/mirror-words.js). Exactly the case the
    ...
    `file\ttcltk\ttcltk.msi\t${'ab'.repeat(32)}\t12288\tamd64`,
