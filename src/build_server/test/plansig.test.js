// Ports the Go server's plansig tests (src/build_server/internal/plansig, retired).
...
test('the server\'s key loads and signs deterministically', (t) => {
  ...
  assert.equal(fs.readFileSync(path.join(dir, PUB_FILE), 'utf8'), fs.readFileSync(path.join(SERVER, 'data', PUB_FILE), 'utf8'));
