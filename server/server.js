...
export function parseFlags(argv, home = os.homedir()) {
  const defs = {
    ...
    bases: [path.join(REPO, 'installer'), 'base installers'],
...
export class Server {
  ...
  // urlencoded or multipart (for the icon). shared/form-job.js turns the fields
  // into the request web/new.js would post, which then goes through the JSON
  ...
  // and with --multi the repository's own web/, shared/ and vendor/.
