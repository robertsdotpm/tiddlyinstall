...
// shared/builder.js needs from a server (stored records, sources and icons,
...
const SIGNED_BY = 'TiddlyInstall TEST';   // our test certificate (installer/windows)
...
export class Builder {
  ...
  // The env shared/builder.js runs a job with on the server.
  env() {
    return {
      catalog: this.cat,
